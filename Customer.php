...
var_dump(sayHello(new Customer("1", "Sakomizu", Gender::from("Mr"))));
var_dump(sayHello(new Customer("2", "Konomi", Gender::from("Mrs"))));
var_dump(sayHello(new Customer("2", "Marina", Gender::tryFrom("Salah"))));
